...
export default function InstructorRegister() {
  ...
  const buildContractText = () => {
    ...
    const cpfRaw = (formData.cpf || '').replace(/\D/g, '') || '________________';
    const birth = formData.birth_date || '____-__-__';
    const phone = formData.phone || '________________';
    const whatsapp = formData.whatsapp_link || '________________';
